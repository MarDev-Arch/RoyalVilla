...
namespace RoyalVilla_API.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<bool> IsEmailExixtsAsync(string email)
        {
        ...
        public async Task<LoginResponseDTO?> LoginAsync(LoginRequestDTO loginRequestDTO)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new InvalidOperationException($"An error occurred during user logging: {ex.Message}", ex);
            }
        }
        ...
        public async Task<UserDTO?> RegisterAsync(RegisterationRequestDTO registerationRequestDTO)
        {
            try
            {
                ...
                if (await IsEmailExixtsAsync(registerationRequestDTO.Email))
                {
                    throw new InvalidOperationException($"Email {registerationRequestDTO.Email} is already in use.");
                }
                User user = new()
                {
